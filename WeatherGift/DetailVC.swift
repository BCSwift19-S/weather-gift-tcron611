...
//  WeatherGift
//
//  Created by Thomas Ronan on 3/9/19.
...
class DetailVC: UIViewController {
    ...
    func updateUserInterface() {
        ...
        let dateString = formatTimeZone(unixDate: location.currentTime, timeZone: location.timeZone)
    ...
    func formatTimeZone(unixDate: TimeInterval, timeZone: String) -> String {
